...
public class ToDoManager {
    ...
    public List<ToDo> listToDos() {
        return new Select().from(ToDo.class).orderBy("due_date ASC").execute();
    }
    ...
    public void markAsUndone(ToDo todoItem) {
        ...
        todoItem.setReceiver(activateAlarm(todoItem));
        todoItem.save();
    ...
    public void create(ToDo createdToDo) {
        ...
        createdToDo.setReceiver(activateAlarm(createdToDo));
        createdToDo.save();
    }
    ...
    public ToDo update(ToDo updateToDo) {
        ...
        // set new alarm
        updateToDo.setReceiver(activateAlarm(updateToDo));
    ...
    private AlarmNotificationReceiver activateAlarm(final ToDo todo) {
